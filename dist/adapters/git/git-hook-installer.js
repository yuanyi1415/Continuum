...
export class GitHookInstaller {
    async install(hooksDirectory, command = "continuum lifecycle checkpoint --source git-post-commit >/dev/null 2>&1 || true") {
...
//# sourceMappingURL=git-hook-installer.js.map