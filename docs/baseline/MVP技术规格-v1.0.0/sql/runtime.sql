...
CREATE TABLE IF NOT EXISTS worktree_bindings (
  ...
  change_id TEXT,
  work_start_revision TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS pending_reconciles (
  ...
  knowledge_impact TEXT NOT NULL CHECK (knowledge_impact IN ('N0','N1','N2','N3','N4')),
...
CREATE TABLE IF NOT EXISTS pending_interactions (
  ...
  type TEXT NOT NULL CHECK (type IN ('STATUS','NOTICE','DECISION','BLOCK')),
